...
class ControlPanel extends StatelessWidget {
  ...
  const ControlPanel({super.key, required this.mission});

  @override
  Widget build(BuildContext context) {
    final p = context.palette;
    final canPause =
        mission.phase == MissionPhase.active || mission.phase == MissionPhase.paused;
    final canReturn = canPause;
                  ...
                  children: [
                    if (mission.phase == MissionPhase.idle) ...[
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          ...
                          icon: Icon(
                            mission.armed ? Icons.lock_open : Icons.lock,
                            size: 18,
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: Icon(
                            mission.phase == MissionPhase.paused
                                ? Icons.play_arrow
                                : Icons.pause,
                            size: 18,
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed:
                              canAbort ? () => _confirmAbort(context, mission) : null,
                    ...
                    Row(
                      children: [
                        ...
                        Icon(
                          failsafeOk ? Icons.check_circle : Icons.error,
                          size: 15,
